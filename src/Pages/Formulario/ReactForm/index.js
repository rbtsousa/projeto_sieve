...
<BackGround>
      ...
      <form>
        ...
        <CreateForm>
          <label htmlFor="nome">Nome<input type="text" placeholder="Digite seu nome" /></label>
          <label htmlFor="nome">Email<input type="email" placeholder="Digite seu email"/></label>
          <label htmlFor="nome">Senha<input type="password" placeholder="Digite sua senha"/></label>
        </CreateForm>

        <CreateForm>
          <label htmlFor="">CPF<input minlength="11" maxlength="11" type="text" placeholder="Digite seu CPF"/></label>
          <label htmlFor="">CEP<input minlength="8" maxlength="8" type="text" placeholder="Digite seu CEP"/></label>
      ...
      <Container2>
        ...
        <CreateForm>
          ...
          <label htmlFor="">Qual é o nível de escolaridade da sua mãe? <input minlength="8" maxlength="8" type="text" placeholder="Digite aqui"/></label>
